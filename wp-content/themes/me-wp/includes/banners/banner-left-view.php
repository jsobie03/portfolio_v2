...
?>
<div class="sub-bnr-home" data-bp="<?php echo esc_attr($background_position_bnr); ?>" data-bs="<?php echo esc_attr($background_size_bnr); ?>" <?php if(!empty($background_image_bnr)){ ?>data-image="<?php echo esc_url($background_image_bnr); ?>" <?php } ?>>
