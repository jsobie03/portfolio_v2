...
<div class="btn-group-vertical align-left" role="group">
    <button type="button" class="btn btn-link" data-trigger="temporary-hide"><span class="text-warning"><i class="glyphicon glyphicon glyphicon-time"></i> <?php esc_html_e( 'Proceed to Bookly Pro without license verification', 'bookly' ) ?></span></button>
</div>