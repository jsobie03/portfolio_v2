...
<div class="tab-pane" id="bookly_settings_google_calendar">
    <form method="post" action="<?php echo esc_url( add_query_arg( 'tab', 'google_calendar' ) ) ?>">
        ...
        <div class="form-group">
            ...
            <p class="help-block"><?php esc_html_e( 'Enter this URL as a redirect URI in the Developers Console', 'bookly' ) ?></p>
        ...
        <?php Inputs::renderTextArea( 'bookly_gc_event_appointment_info', __( 'Appointment section', 'bookly' ), __( 'This section describes information that is displayed about appointment.', 'bookly' ) ) ?>
        <?php $self::renderTemplate( '_gc_appointment_codes', array( 'participants' => 'many' ) ) ?>
        <br>
        <?php Inputs::renderTextArea( 'bookly_gc_event_client_info', __( 'Customer section', 'bookly' ), __( 'This section describes information that is displayed about each participant of the appointment.', 'bookly' ) ) ?>
        <?php $self::renderTemplate( '_gc_client_codes', array( 'participants' => 'one' ) ) ?>
