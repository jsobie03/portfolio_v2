...
<div class="bookly-extra-step">
    ...
    <?php if ( in_array( 'summary', $show ) ) : ?>
        <div class="bookly-box bookly-extras-summary bookly-js-extras-summary"><?php _e( 'Summary', 'bookly' ) ?>:<?php if ( $chain_price !== null ): ?> <?php echo Price::format( $chain_price ) ?><?php endif ?><span><?php echo ( $amount ) ? ' + ' . Price::format( $amount ) : '' ?></span></div>
    <?php endif ?>
</div>
